...
patch -u ${GRAMMAR_DIR}/RealIntsRealVars.g4 -i grammar.patch -o grammar.g4

Z3_CFG="${BIN_DIR}/z3-aa6ec41"
CVC5_CFG="${BIN_DIR}/cvc5-425a28b99 --nl-icp -q"
Grammar=`realpath grammar.g4`

echo prepare_grammar $Grammar 
prepare_grammar $Grammar 
timeout -s 9 160 enumerate "$Z3_CFG;$CVC5_CFG" 5 -n 20||true
