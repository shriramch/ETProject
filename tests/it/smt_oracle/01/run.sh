...
#cp /BitvectorArrays.g4 grammar.g4
Z3_CFG="bin/z3-aa6ec41 model_validate=true smt.array.extensional=false"
CVC_CFG="bin/z3-aa6ec41 model_validate=true smt.array.extensional=false"
